...
\docTerm{awaredate}{aware date}{%
  The date \gls{company} has determined a complaint to meet requirements for reporting
...
\docTerm{corrective-action}{corrective action}{%
  ...
  product, process, or quality system non-conformance, defect, trend, or other
...
\docTerm{finished-goods}{finished goods}{%
  ...
  prior to being sold by \gls{company}.
}%
...
\docTerm{oem-product}{oem product}{%
  Product(s) (finished devices, drug or biologics) used and/or sold by
  \gls{company}, which are manufactured by an OEM Supplier. This includes products that
...
\docTerm{organizational-entity}{organizational entity}{%
  ...
  in a particular way with another to perform and manage business. \Gls{company}
  organizational entities include Corporate, Group, Business Unit and Site
  entities.
}%
...
\docTerm{quality-audit}{quality audit}{%
  ...
  of such activities comply with quality system procedures, that the procedures
...
\docTerm{supply-risk}{supply risk}{%
  The actual or potential business impact that a supplier poses to \gls{company}.
}%
