...
\newcommand{\autodocHeaderFooterFootRightLineA}{\autodocConfidential -- Proprietray information of \autodocCompanyName}%
...
% should be replace with your actual producdt name.
