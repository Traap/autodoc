...
% file.  The template hooks everything autodoc can do into your document.
%
...
\newcommand{\autodocCompanyName}{Bracco Medical Technologies (BMT)}%
\newcommand{\autodocConfidential}{Confidential}%
\newcommand{\autodocDepartmentName}{Firmware Department}%
\newcommand{\autodocProductName}{SF90}%
...
\newcommand{\autodocHeaderFooterInstitution}{\autodocConfidential -- Proprietary information of \autodocCompanyName}%
...
\newcommand{\autodocHeaderFooterHeadHeight}{67.76913pt}%
\newcommand{\autodocHeaderFooterFootSkip}{27.5003pt}%

\newcommand{\autodocHeaderFooterFootLeftLineA}{SOP-700-08}%
\newcommand{\autodocHeaderFooterFootLeftLineB}{FM0417, Rev 08}%
\newcommand{\autodocHeaderFooterFootLeftLineC}{CO-07374}%

\newcommand{\autodocHeaderFooterFootRightLineA}{\autodocConfidential -- Proprietary information of \autodocCompanyName}%
\newcommand{\autodocHeaderFooterFootRightLineB}{This document is maintained in the document control system.}%
\newcommand{\autodocHeaderFooterFootRightLineC}{Confirm current version prior to use.}%

\newcommand{\autodocHeaderFooterGeometry}{%
  \geometry{%
    top=0.50in,%
    bottom=0.25in,%
...
\newacronym[description={%
  ...
  ill patients.
}]{company}{BMT}{Bracco Medical Technologies}%

\newacronym[description={%
 JAMA Soft is requirements and test management software.
}]{jama}{JAMA}{JAMA Soft}%
...
% TODO: These are example product definitions used throughout autodoc.  Each one
% should be replaced with your actual product name.
...
\newacronym[description={%
  Vigilant Centerium is a software-only application that is intended to perform the
...
\newacronym[description={%
 Vigilant Sentinel is a software-only application that is an infusion
...
\newacronym[description={%
 Verification and Validation Plan defines a plan.
}]{vvp}{VVO}{Verification and Validation Plan}%ouse>
...
\docTerm{device-uploader}{device uploader}{%
 Device Uploader is a software application that uploads new binary images to an
 embedded target.
}%
