...
\begin{longtable}[ht]{|L{3.5cm}|L{5.5cm}|L{5.5cm}|}\hline%
  ...
  \endhead%
    ...
    CHANGE CONTROL REFERENCE & \useAutoDocFile{data/dnd-plan-number.tex} & \useAutoDocFile{data/dnd-plan-title.tex} \ER% 
    Document Control System Application & N/A & SmartSolve 9.0 \ER%
    PROJECT DESIGN HISTORY FILE & \useAutoDocFile{data/pkg-num-project.tex} & \useAutoDocFile{data/pkg-title-project} \ER%
    SOFTWARE DESIGN HISTORY FILE & \useAutoDocFile{data/pkg-num-sw.tex} & \useAutoDocFile{data/pkg-title-sw} \ER%
