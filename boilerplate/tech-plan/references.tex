...
\begin{longtable}[ht]{|L{3.5cm}|L{5.5cm}|L{5.5cm}|}\hline%  
  ...
  PROJECT DESIGN HISTORY FILE & \input{data/pkg-num-project.tex} 
  & \input{data/pkg-title-project} \ER%
  
  SOFTWARE DESIGN HISTORY FILE & \input{data/pkg-num-sw.tex} 
  & \input{data/pkg-title-sw} \ER%
