...
suite which is a set of Microsoft Windows-based web applications that provide
reporting and Dose Error Reduction System configuration and distribution for
infusion pumps.  
...
\begin{itemize}
  \item A software architecture capable of supporting the designs required to
    meet the VSS product and system requirements.
  \item A set of traceable software requirements specifications and software
    designs meeting the VSS product and system requirements.
  ...
  \item A VSS software development environment capable of developing and
