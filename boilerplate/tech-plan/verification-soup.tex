\subsection{SOUP}
In the software product, numerous software components use the \gls{soup} to perform
...
requirements that use the SOUP is chosen.  This chosen set of product
system requirements is tested in the normal course of design verification and
design validation.  The successful testing of these product requirements implies
