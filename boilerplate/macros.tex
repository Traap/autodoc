...
\newcommand{\setTOFPath}[1]{%
 \renewcommand{\tcCap}{#1 Step \theFileCnt-Image \theStepCnt}
 \renewcommand{\tcCsv}{#1.csv}%
 \renewcommand{\tcLog}{#1.tex}%
 \renewcommand{\tcPng}{#1-\zerofill{\theFileCnt}-\zerofill{\theStepCnt}.png}
 \renewcommand{\tcStyleCaption}{\caption{\tcCsv}}%
}%

\newcommand{\setTOFPathC}[3]{%
 \renewcommand{\tcCap}{#3 Step \theFileCnt-Image \theStepCnt}
