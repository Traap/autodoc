...
a list of the software requirements tested, one or more Test Reports, evidence
...
a conclusion that the software requirements for the target device have been
verified.
