...
\newcommand{\tcCsvResultCapDataMissing}{%
  \begin{flushleft}%
    \scriptsize%
    \textbf{Step:~}N/A~%
    \textbf{File:~}N/A%
  ...
  \IfFileExists{#1}{%
    ...
    \begin{center}%
      ...
      \csvreader[tcStyle, separator=pipe,%
        %filter ifthen=\equal{\status}{PASS} \or \equal{\status}{FAIL} ,%
        ]%
        {#1}% CSV file name
        {}%   Filtering.
...
% ------------------------------------------------------------------------------
% Include the summary results
% 
\newcommand{\includeSummaryResults}
{

   \begin{tikzpicture}
     \pie[red, explode=0.1]{\percPASS/PASS,\percFAIL/FAIL,\percMISSING/MISSING}
      \legend[shift={(0cm,-1cm)}]{{PASS}/PASS, {FAIL}/FAIL, {MISSING}/MISSING}
   \end{tikzpicture}
}
